          ...
          <div className="grid md:grid-cols-12 gap-10 items-center">
            <div className="md:col-span-6 reveal">
              ...
              <p className="mt-5 text-[16px] text-ink-soft leading-relaxed max-w-lg">
                ...
                and the same people who scope the work shipping it. US- and EU-friendly hours where your roadmap needs overlap.
              </p>
              <div className="mt-8 grid grid-cols-2 gap-5 max-w-md">
                {[
                  ['Fast replies', 'Usually same working day'],
                  ['Full stack', 'Marketing + product'],
                  ['Mumbai', 'HQ & timezone'],
                  ['India · US', 'Markets we know'],
                ].map(([k,v]) => (
        ...
        <Section>
          <div className="reveal rounded-3xl bg-cyan-soft border border-cyan/40 p-10 md:p-16 grid md:grid-cols-12 gap-8 items-center">
            ...
            <div className="md:col-span-4 md:text-right">
              <button onClick={() => go('/contact')} className="btn-primary inline-flex items-center gap-2 px-7 py-4 rounded-full font-sans text-[14px] font-semibold">
