      ...
      <section className="py-24 bg-cyan-soft/40">
        <Section>
          ...
          <div className="space-y-20">
            {SERVICES.map((s, i) => (
              <div key={s.id} className={`reveal grid md:grid-cols-12 gap-10 items-center ${i % 2 === 1 ? 'md:[&>:first-child]:order-2' : ''}`}>
                ...
                <div className="md:col-span-7">
                  ...
                  <button onClick={() => go('/contact')} className="mt-7 btn-primary inline-flex items-center gap-2 px-6 py-3 rounded-full font-sans text-[13px] font-semibold">
        ...
        <Section>
          <div className="reveal rounded-3xl bg-midnight text-paper p-10 md:p-16 grid md:grid-cols-12 gap-8 items-center relative overflow-hidden">
            ...
            <div className="md:col-span-4 md:text-right relative">
              <button onClick={() => go('/contact')} className="bg-cyan text-midnight inline-flex items-center gap-2 px-7 py-4 rounded-full font-sans text-[14px] font-semibold hover:bg-paper transition-colors">
