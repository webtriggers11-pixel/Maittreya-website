...
import { useReveal, Section, Eyebrow } from '@/components/shared';
        ...
        <Section>
          <div className="max-w-3xl reveal">
            ...
            <p className="mt-6 text-[15px] text-ink-soft leading-relaxed">
              This page is a placeholder. Replace with your final policy before launch.
            </p>
          </div>
        </Section>
      </section>
      ...
      <section className="pb-24">
        <Section>
          <div className="max-w-3xl reveal space-y-6 text-[15px] leading-relaxed text-ink-soft">
            <p>
              <strong className="text-ink">Information we may collect:</strong> name, email, phone, and message content when you use our contact or lead forms.
            </p>
            <p>
